...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-svc-page-svc-page-module"], {
  ...
  /***/
  function srcAppPagesSvcPageServiceCardServiceCardComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function ServiceCardComponent_div_2_li_6_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ServiceCardComponent_div_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ServiceCardComponent_ng_template_3_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 5);
    ...
    function ServiceCardComponent_li_7_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var ServiceCardComponent = /*#__PURE__*/function () {
      function ServiceCardComponent(router, //for back button
      actRoute) {
      ...
      _createClass(ServiceCardComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.subActRoute = this.actRoute.data.subscribe(function (data) {
            _this.asideListCard = data.asideList;
          });
          this.subParams = this.actRoute.params.subscribe(function (params) {
            _this.paramsName = params.name;
            _this.subService = _this.actRoute.data.subscribe(function (data) {
              _this.serviceInfo = data.serviceInf;
              _this.serviceShowedComponent = _this.serviceInfo.find(function (point) {
                return point.name === _this.paramsName;
              });
            });
          });
        }
        ...
        value: function ngAfterContentChecked() {
          ...
          this.serviceShowedComponent = this.serviceInfo.find(function (point) {
            return point.name == _this2.paramsName;
          });
        }
      }, {
        key: "ngOnDestroy",
    ...
    ServiceCardComponent.ɵfac = function ServiceCardComponent_Factory(t) {
      return new (t || ServiceCardComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"]));
    };

    ServiceCardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ServiceCardComponent,
      selectors: [["app-service-card"]],
      decls: 8,
      vars: 3,
      consts: [[1, "canvas"], ["class", "information", 4, "ngIf", "ngIfElse"], ["loading", ""], [1, "sidebar"], ["class", "slip", 3, "routerLink", "id", 4, "ngFor", "ngForOf"], [1, "information"], [1, "heading"], ["id", "text-before"], ["id", "list-work"], ["class", "items", 4, "ngFor", "ngForOf"], ["id", "text-after"], [1, "about"], [1, "items"], [1, "slip", 3, "routerLink", "id"], [3, "ngStyle"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["NgIf"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["NgForOf"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterLink"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["NgStyle"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ServiceCardComponent, [{
  ...
  /***/
  function srcAppPagesSvcPageSvcPageModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SVCPageModule", function () {
      return SVCPageModule;
    });
    /* harmony import */
    ...
    var _service_card_service_card_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./service-card/service-card.component */
    "./src/app/pages/svc-page/service-card/service-card.component.ts");
    /* harmony import */


    var src_app_shared_resolvers_asidelist_resolver__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! src/app/shared/resolvers/asidelist.resolver */
    "./src/app/shared/resolvers/asidelist.resolver.ts");
    /* harmony import */


    var src_app_shared_resolvers_serviceinfo_resolver__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! src/app/shared/resolvers/serviceinfo.resolver */
    ...
    var SVCPageModule = function SVCPageModule() {
      _classCallCheck(this, SVCPageModule);
    };

    SVCPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: SVCPageModule
    });
    SVCPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function SVCPageModule_Factory(t) {
        return new (t || SVCPageModule)();
      },
      imports: [[src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_2__["SharedModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](SVCPageModule, {
        declarations: [_service_card_service_card_component__WEBPACK_IMPORTED_MODULE_3__["ServiceCardComponent"]],
        imports: [src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_2__["SharedModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SVCPageModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
          declarations: [_service_card_service_card_component__WEBPACK_IMPORTED_MODULE_3__["ServiceCardComponent"]],
          imports: [src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_2__["SharedModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)],
          exports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
        }]
      }], null, null);
    })();
  ...
  /***/
  function srcAppSharedResolversServiceinfoResolverTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ServiceInfoResolver", function () {
    ...
    var ServiceInfoResolver = /*#__PURE__*/function () {
      function ServiceInfoResolver(reqService) {
        _classCallCheck(this, ServiceInfoResolver);

        this.reqService = reqService;
      }

      _createClass(ServiceInfoResolver, [{
        key: "resolve",
    ...
    ServiceInfoResolver.ɵfac = function ServiceInfoResolver_Factory(t) {
      return new (t || ServiceInfoResolver)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](src_app_shared_services_request_service__WEBPACK_IMPORTED_MODULE_1__["RequestService"]));
    };

    ServiceInfoResolver.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: ServiceInfoResolver,
      factory: ServiceInfoResolver.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ServiceInfoResolver, [{
...
//# sourceMappingURL=pages-svc-page-svc-page-module-es5.js.map